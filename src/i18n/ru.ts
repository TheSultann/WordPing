const ru = {
  ...
  'add.needEnglishWord': '✏️ <b>Не смог получить английский вариант.</b>\n👇 Напиши слово на английском вручную.',
  'add.apiLimitManualTranslation': '🛑 <b>Лимит автоперевода на сегодня исчерпан ({limit}).</b>\n👇 Напиши перевод вручную:',
